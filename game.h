...
class Game : public graphics::AnimationEventListener,public graphics::MouseEventListener { 
    ...
    std::vector<OpponentProjectile>& GetOpponentProjectiles() { return opponent_projectiles_; }  
    std::vector<PlayerProjectile>& GetPlayerProjectiles() { return player_projectiles_; }  
